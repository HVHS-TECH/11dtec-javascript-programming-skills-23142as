/**************************** 
 Name of task: Intro to  array
 Person who wrote it: Adarsh 
 Date written: 5/1/2025
 Purpose: Introduction of  array
 ****************************/
...
var Born = 2010;
 ...
 let choice = prompt("Pick number from o to 3");
alert("Your chosen number was" +choice+ ".You think" +classArray [choice]);
